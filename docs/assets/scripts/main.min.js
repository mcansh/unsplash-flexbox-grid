...
var authToken = 'c3afc03ed46432d238b22900dc53d153df82bd53b153ac7d619d5b61c9538533';
'use strict';

// @codekit-prepend 'jquery-3.1.1.min.js';
// @codekit-prepend 'tokens.js';
var consoleStyles = ['color: white', 'display: block', 'font-size: 30px', 'line-height: 35px', 'text-align: center', 'font-family: OperatorMono-bold, avenir, -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"'].join(';');

var pageNumber = 1;
var amountPerPage = 30;
var order = 'latest';
var url = 'https://api.unsplash.com/photos?page=' + pageNumber + '&per_page=' + amountPerPage + '&order_by=' + order + '&client_id=' + authToken;
